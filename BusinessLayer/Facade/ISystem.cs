...
namespace BusinessLayer.Facade
{
    public interface ISystem
    {
        ...
        Dictionary<string, string> ShowLesson(Dictionary<string, string> data, string token);
        ...
        Dictionary<string, string> ShowCourse(Dictionary<string, string> data, string token);
        ...
        Dictionary<string, string> ShowAccount(Dictionary<string, string> data, string token);
        (bool, string) AssignRegistrationDate(Dictionary<string, string> data, string token);
        IEnumerable<Field> ShowFields(string token);
        Dictionary<string, string> ShowField(Dictionary<string, string> data, string token);
